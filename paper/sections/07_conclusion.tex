...
The current tables provide bounded single-run evidence on strong-related
Amazon transfer and weak cross-platform TripAdvisor--Yelp transfer. Future
evidence additions can extend this draft with module ablations, multi-seed
evaluation, broader baseline adaptation, and human or faithfulness-oriented
assessment without changing the central ODCR story.
