...
We report current results on three Amazon target-domain settings, treating
them as bounded evidence for the proposed dynamic causal refinement rather
than as a multi-seed benchmark-dominance claim.
\end{abstract}
