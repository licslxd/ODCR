...
REQUIRED_TRUE_FLAGS = (
    ...
    "resolver_validates_readiness_audit",
...
def build_machine_verdict(fields: Mapping[str, Any]) -> dict[str, Any]:
    payload = {
        ...
        "resolver_validates_readiness_audit": False,
        ...
        "step4_blocked_upstream_gate_status": "failed",
        "step4_ready_upstream_gate_status": "failed",
